...
$(TMPDIR)/upheno-relations-merged-reasoned.owl: $(TMPDIR)/upheno_has_phenotype_affecting.owl $(TMPDIR)/upheno-relations.owl $(SRC)
	$(ROBOT) merge -i $(SRC) unmerge -i $@ \
		merge -i $(TMPDIR)/upheno_has_phenotype_affecting.owl -i $(TMPDIR)/upheno-relations.owl \
		reason query --update ../sparql/eq-process-anatomy.ru materialize --term UPHENO:0000003 --term UPHENO:0000001 --term UPHENO:0000005 -o $@
...
$(COMPONENTSDIR)/eq-relations.owl: $(TMPDIR)/upheno-relations-merged-reasoned.owl
	$(ROBOT) merge -i $(TMPDIR)/upheno-relations-merged-reasoned.owl reduce filter --term UPHENO:0000003 --term UPHENO:0000005 --term UPHENO:0000001 --trim false annotate --ontology-iri $(ONTBASE)/$@ -o $@
